...
const ServicesPage = () => {
  return(
	<Page pageMeta={{
	  ...
	  description: 'Подробнее про услуги: создание сайтов под ключ (квиз-сайт и лэндинг, сайт-визитка, корпоративный сайт-каталог, блог, информационный портал, интернет-магазин), разработка мобильных и адаптивных версий сайтов и редизайн, СЕО-продвижение по Воронежу, Москве, России в Яндексе и Google, SMM-маркетинг.'}}>
