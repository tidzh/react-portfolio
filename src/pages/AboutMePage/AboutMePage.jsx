  ...
  return (
	<Page pageMeta={{
	  ...
	  <Box component="section" pt={8} pb={8} bgcolor="bgGrey">
		<Container>
		  <Heading title={'Обо мне'} subtitle='Давайте знакомиться' Tag={'h1'}/>
		  <Typography align="center">
			Здравствуй! Меня зовут Кондаков Александр. Я веб-разработчик, и я очень увлечен и предан своей работе. Имея 7-летний опыт работы в качестве профессионального веб-разработчика, я приобрел навыки и знания, необходимые для успеха вашего проекта.
		  </Typography>
