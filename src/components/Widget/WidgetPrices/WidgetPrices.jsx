	...
	<Grid container spacing={3}>
	  <Grid item sm={6} md={3}>
		<Box p={2} className={style.item}>
		  ...
		  <Typography variant="caption" display="block" gutterBottom className={style.text}>
			Одностраничный сайт со статичной структурой, для размещения основной информации о компании
		  </Typography>
		  ...
		  <ul className={style.list}>
			...
			<li>Наполнение сайта (информацией по материалам Заказчика) в подарок</li>
	  ...
	  <Grid item sm={6} md={3}>
        <Box p={2} className={style.item}>
          ...
          <Typography variant="caption" display="block" gutterBottom className={style.text}>
			Рекламный инструмент для запуска промо акций отдельного товара или услуги
		  </Typography>
          <Box display="flex" justifyContent="center" alignItems="center" mt={2} mb={2}>
            <TimerIcon fontSize="small"/>
      ...
      <Grid item sm={6} md={3}>
		<Box p={2} className={style.item}>
          ...
          <Typography variant="caption" display="block" gutterBottom className={style.text}>
			Полнофункциональный торговый сайт с каталогом товаров и корзиной для онлайн-продаж товаров
		  </Typography>
          <Box display="flex" justifyContent="center" alignItems="center" mt={2} mb={2}>
            <TimerIcon fontSize="small"/>
	  ...
	  <Grid item sm={6} md={3}>
        <Box p={2} className={style.item}>
          ...
          <Typography variant="caption" display="block" gutterBottom className={style.text}>
			SPA — это новый формат ресурсов. Быстрая и плавная загрузка полномасштабных приложений на одной странице.
		  </Typography>
          <Box display="flex" justifyContent="center" alignItems="center" mt={2} mb={2}>
            <TimerIcon fontSize="small"/>
